# Session Summary - 2025-08-03 04:51:33
...
.claude/checkpoints/summary-session-20250803-040628.md
.claude/checkpoints/task-1754193010.json
.claude/checkpoints/task-1754194026.json
.claude/checkpoints/task-1754195194.json
CLAUDE.md
scripts/test-odoo-direct.py
supabase/functions/_shared/odoo-client.ts
supabase/functions/create-supplier-relationships-standalone/index.ts
supabase/functions/debug-odoo-products/index.ts
supabase/functions/test-searchread-standalone/index.ts
supabase/functions/test-searchread/index.ts
