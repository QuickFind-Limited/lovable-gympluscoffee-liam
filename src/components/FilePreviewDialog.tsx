                  ...
                  {csvRows.length > 0 ? (
                    <table className="min-w-full border border-border text-sm">
                      <thead className="bg-muted/40">
                        <tr>
                          {csvRows[0].map((h, i) => (
                            <th key={i} className="px-3 py-2 border-b border-r text-left font-semibold text-foreground/90">
                              {h}
                            </th>
                          ))}
                        </tr>
                      ...
                      <tbody>
                        {csvRows.slice(1).map((r, ri) => (
                          <tr key={ri} className={ri % 2 === 0 ? "bg-background" : "bg-muted/20"}>
                            {r.map((c, ci) => (
                              <td key={ci} className="px-3 py-2 border-b border-r whitespace-pre-wrap break-words align-top">
                                {c}
                              </td>
                            ))}
