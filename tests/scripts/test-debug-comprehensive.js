// Test the comprehensive debug function
...
async function testDebugComprehensive() {
  try {
    console.log('Running comprehensive debug test...');
    
    const response = await fetch(`${SUPABASE_URL}/functions/v1/debug-search-issue`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error in comprehensive debug test:', error);
  }
}

testDebugComprehensive();