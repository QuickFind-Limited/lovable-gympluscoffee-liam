// Test the v2 odoo-product-search function
...
async function testV2Search() {
  try {
    console.log('=== TESTING odoo-product-search-v2 ===\n');
    
    // Test searching for "acra"
    console.log('Searching for "acra"...');
    const response = await fetch(`${SUPABASE_URL}/functions/v1/odoo-product-search-v2`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error testing v2 search:', error);
  }
}
